...
12/29/2010
This Twitter - OAuth package is available here

https://github.com/bengottlieb/Twitter-OAuth-iPhone

Huge thanks goes to Ben, Matt, John, Chris, and Isaiah for their previous works
(see below)
...
Example:
Use the project in the Demo folder. You'll need to replace the strings in 
Demo/Src/OAuthTwitterDemoViewController.m with your own consumer key and consumer secret 
(visit  http://twitter.com/oauth_clients/new to obtain these).
...
License: None found.
Isaiah's test app worked great on the Mac, but didn't make use of the PIN number 
passed back by Twitter, and also needed to be re-worked to work on the phone.
